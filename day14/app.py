...
# Description
st.markdown("""
This app predicts the species of an Iris flower based on its measurements using a machine learning
...
with st.expander("📚 About the Iris Dataset"):
    st.markdown("""
        The Iris flower dataset is a classic dataset in machine learning and statistics indroducer
